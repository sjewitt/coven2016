...
;
        ...
        var startContentFlow = function(elem){
            ...
            if(weddingfest07.ContentFlowConfig.loadContentFlow){
                ...
                //and attach swipe handler:
                
                //TODO: Trigger this ONLY if tablet etc.
                $("#contentFlow").swipe({
                    //http://labs.rampinteractive.co.uk/touchSwipe
                    swipe:function(event, direction, distance, duration, fingerCount, fingerData) {
                        var currentIndex = myNewFlow.getActiveItem().index;
                        //call contentflow event:
                        switch(direction){
                            case "left":
                                myNewFlow.moveToIndex(currentIndex + 1);
                                break;
                            case "right":
                                myNewFlow.moveToIndex(currentIndex - 1);
                                break;
                    ...
                    tap:function(event, target){
                        var src = $(myNewFlow.getActiveItem().canvas).attr("src");
                        var _img = new Image();
                        _img.src = src;
